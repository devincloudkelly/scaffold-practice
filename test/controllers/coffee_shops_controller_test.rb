...
class CoffeeShopsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create coffee_shop" do
    assert_difference('CoffeeShop.count') do
      post coffee_shops_url, params: { coffee_shop: { featured_drink: @coffee_shop.featured_drink, name: @coffee_shop.name } }
    end
  ...
  test "should update coffee_shop" do
    patch coffee_shop_url(@coffee_shop), params: { coffee_shop: { featured_drink: @coffee_shop.featured_drink, name: @coffee_shop.name } }
